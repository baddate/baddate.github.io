...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},r,a]}}})());hljs.registerLanguage("nginx",(()=>{"use strict";return e=>{const n={
...
aliases:["yml","YAML"],contains:b}}})());hljs.registerLanguage("cmake",(()=>{"use strict";return e=>({name:"CMake",
...
},e.HASH_COMMENT_MODE,e.QUOTE_STRING_MODE,e.NUMBER_MODE]})})());hljs.registerLanguage("properties",(()=>{"use strict";return e=>{
...
starts:i},{className:"attr",relevance:0,begin:s+n+"$"}]}}})());hljs.registerLanguage("julia",(()=>{"use strict";return e=>{
...
starts:{end:/^(?![ ]{6})/,subLanguage:"julia"},aliases:["jldoctest"]}]})})());hljs.registerLanguage("kotlin",(()=>{"use strict";return e=>{const n={
...
starts:{end:/$/,contains:[i,c,r,t,l,a]}}]}}})());hljs.registerLanguage("arduino",(()=>{"use strict";return e=>{const t=(e=>{
...
t.name="Arduino",t.aliases=["ino"],t.supersetOf="cpp",t}})());hljs.registerLanguage("python-repl",(()=>{"use strict";return s=>({
...
},{begin:s+":",end:":",returnBegin:!0,returnEnd:!0,relevance:0}])}}})());hljs.registerLanguage("mipsasm",(()=>{"use strict";return e=>({
...
begin:"[0-9]+[bf]"}],relevance:0}],illegal:/\//})})());hljs.registerLanguage("vim",(()=>{"use strict";return e=>({name:"Vim Script",
keywords:{$pattern:/[!#@\w]+/,
...
className:"symbol",begin:/<[\w-]+>/}]})})());hljs.registerLanguage("markdown",(()=>{"use strict";function n(...n){
...
starts:{end:/[^\\]$/,subLanguage:"bash"}}],illegal:"</"})})());hljs.registerLanguage("scss",(()=>{"use strict";return e=>{var t="@[a-z-]+",i={
...
name:"Less",case_insensitive:!0,illegal:"[=>'/<($\"]",contains:a}}})());hljs.registerLanguage("awk",(()=>{"use strict";return e=>({name:"Awk",keywords:{
...
}],illegal:/\S/}}})());hljs.registerLanguage("c-like",(()=>{"use strict";return e=>{function t(e){
...
className:"class",beginKeywords:"enum class struct union",end:/[{;:<>=]/,
contains:[{beginKeywords:"final class struct"},e.TITLE_MODE]}]),exports:{
preprocessor:c,strings:s,keywords:u}}}})());hljs.registerLanguage("http",(()=>{"use strict";return e=>{
...
begin:"\\."+e.UNDERSCORE_IDENT_RE,relevance:0}]}}})());hljs.registerLanguage("latex",(()=>{"use strict";return e=>{const n=[{
